...
public class ControleChamadosTeste {
    ...
    public ControleChamadosTeste() {
    }
     @Test
    public void testeAlteraçãoChamadoRede() {
        Tecnico tecnico = new Tecnico("Diego", 4321);
        Empresa empresa = new Empresa(321, "Samsung");
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(1, empresa, 2197534L, "Denis", 321);
        Chamado chamado1 = new Chamado("Título", "Descrição", 2, tecnico, clienteEmpresa, "Linux", "minix", "Operação realizada com sucesso", 20.0);
    ...
    public void testeInsercaoChamadoBancoDeDados() {
        Tecnico tecnico = new Tecnico("Diego", 4321);
        Empresa empresa = new Empresa(321, "Samsung");
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(001, empresa, 40168413824L, "Caleb", 12123434);
        Chamado chamadoBancoDados = new Chamado("Título do chamado", "Descrição do chamado", 2, tecnico, clienteEmpresa, "Linux", "minix", "Oracle");
    ...
    public void testeInsercaoChamadoControleChamados() {
        ...
        Empresa empresa = new Empresa(321, "Samsung");
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(1, empresa, 2197534L, "Denis", 321);
        Chamado rede = new Chamado(01, "Título", "Descrição", 2, tecnico, clienteEmpresa, "Linux", "minix", "Modem", "192.168.0.1");
    ...
    public void testeInsercaoChamadoDesempenho() {
        ...
        Empresa empresa = new Empresa(321, "Samsung");
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(1, empresa, 2197534L, "Denis", 321);
        Chamado chamadoDesempenho = new Chamado("Título", "Descrição", 2, tecnico, clienteEmpresa, "Linux", "minix", "Operação realizada", 20.0);
        ControleChamados controleChamado = new ControleChamados();
    ...
    public void testeInsercaoRegistroChamado() {
        ...
        Empresa empresa = new Empresa(321, "Samsung");
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(1, empresa, 2197534L, "Denis", 321);
        Chamado chamadoDesempenho = new Chamado("Título do chamado", "Descrição do chamado", 2, tecnico, clienteEmpresa, "Linux", "minix", "Operação realizada", 20.0);
        ControleChamados controleChamados = new ControleChamados();
    ...
    public void testeContarQuantidadeChamadosClienteControleChamados() {
        ...
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(1, empresa, 2197534L, "Denis", 321);
        Chamado chamadoDesempenho = new Chamado("Título ", "Descrição", 2, tecnico, clienteEmpresa, "Linux", "minix", "Operação realizada", 20.0);
        Chamado chamadoBancoDados = new Chamado("Título banco de dados: ", "Descrição do segundo chamado", 2, tecnico, clienteEmpresa, "Linux", "minix", "Oracle");
        ControleChamados controleChamados = new ControleChamados();
    ...
    public void detalhesChamadoControleChamadosTest() {
        ...
        Empresa empresa = new Empresa(321, "Samsung");
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(1, empresa, 2197534L, "Denis", 321);
        Chamado chamado = new Chamado("Título ", "Descrição do primeiro chamado", 1, tecnico, clienteEmpresa, "Linux", "minix 2.3", "Operação realizada", 20.0);
        ...
        String detalhes = "Abertura: " + chamado.getData() + "\n" + "Chamado aberto às: " + chamado.getHora() + "\n"
                ...
                + "Tipo de problema: " + "Desempenho" + "\n" + "Tecnico responsável: "+ "Diego" + "\n" + "Cliente: " + "Contrato: " + "321"
                + "Nome Empresa:" + "Samsung" + " - Cliente: "+ "2197534L" + " Nome do Cliente: " + "Denis" + "\n";
        ControleChamados controleChamado = new ControleChamados();
